...
resource "aws_eks_cluster" "ec" {
  name     = "three-tier-app"
  role_arn = aws_iam_role.tertis.arn
...
resource "aws_eks_node_group" "ng" {
  cluster_name    = aws_eks_cluster.ec.name
  node_group_name = "three-tier-node-1"
